...
installChaincode () {
	...
	setGlobals $PEER
	#安装链码
	peer chaincode install -n das -v 1.0 -p github.com/hyperledger/fabric/examples/chaincode/go/das >&log.txt #链码名称 das  ， 链码路径github.com/hyperledger/fabric/examples/chaincode/go/das
